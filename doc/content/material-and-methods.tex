...
Figure \ref{fig:isys} shows the device developed in this thesis. The following sections describes the design of the sensor system and all components involved.
...
\end{tikzpicture}
		...
		\caption{System Design: the yellow area marks the user facing side of the system, the green area is the hardware that is mounted on the carrier board and the blue are marks the sensors deployed in the water stream. The rectangle marks the part of the system that is repeated $n$ times to get to the needed number of sensors.}
		\label{fig:sys}
	\end{center}
\end{figure}
